...
export default function ServicesConclusion() {
  ...
  const translations = {
    ...
    ar: "تتميز مدرستنا برج إيفّل بمجموعة شاملة من الخدمات المصممة لتلبية احتياجات كل طالب. من خلال تطبيقنا المحمول البديهي، نسهل التواصل والإدارة اليومية، بينما تضمن حلول النقل لدينا الأمان والدقة في المواعيد. تقدم الكانتين نظامًا غذائيًا متوازنًا، وهو أمر ضروري لرفاهيتهم. علاوة على ذلك، تساهم الأندية وورش العمل المتنوعة – التي تشمل التوجيه الأكاديمي والحساب الذهني والمسرح والتوجيه والمكتبة والروبوتات والرياضيات المتقدمة – في تطوير المهارات الأكاديمية والمواهب الشخصية. كما تعتني العيادة الصحية بصحة الطلاب، مما يوفر بيئة آمنة وداعمة لنموهم الشامل"
  };
