    ...
    return (
        <>
            ...
            >
                ...
                <div className={`w-[4%] scale-110 gap-y-2 pb-5 bottom-0 left-6 lg:left-1 fixed flex flex-col items-center language ease-in duration-200 z-[999] ${!showLang&&" mt-24 lg:mt-0 lg:opacity-100"} `}>
                    <AnimatePresence>
                        {langClicked && (
                            <motion.div
                                key="lang-menu"
